    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chargerSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                if (isChecked) {
                    ...
                    if (chargerFlag != 1) {
                        Toast.makeText(HomeActivity.this, "Sarj Aletine Bağlayınız.", Toast.LENGTH_SHORT).show();
        ...
        motionSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                if (isChecked) {
                    alertDialog.setTitle("Alarm Aktifleşiyor...");
                    ...
                    cdt = new CountDownTimer(10000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            mSwitchSet = 1;
                            alertDialog.hide();
                            Toast.makeText(HomeActivity.this, "Deprem Algılama Modu Aktif.", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(HomeActivity.this, "Deprem Algılama Modu Kapatıldı.", Toast.LENGTH_SHORT).show();
                    mSwitchSet = 0;
                }
        ...
        proximitySwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                if (isChecked) {
                    alertDialog.setTitle("Telefonu Yerine Yerleştiriniz...");
                    alertDialog.setMessage("00:10");
                    ...
                    Toast.makeText(HomeActivity.this, "Mod Kapatıldı.", Toast.LENGTH_SHORT).show();
                    pSwitchSet = 0;
                }
