...
//        mSensorManager.unregisterListener(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aktivite_sifre_ayarla);
...
//                }
                 ...
                 if(TextUtils.isEmpty(pin) || pin.length()<4) {
                    etSetPin.setError("Şifre en az 4 haneli olmalıdır!");
                    etSetPin.requestFocus();
                    return;
                }
                else if(TextUtils.isEmpty(confirmPin) || confirmPin.length()<4) {
                    etConfirmPin.setError("Şifre en az 4 haneli olmalıdır!");
                ...
                if(pin.equals(confirmPin)){
                    ...
                    editor.commit();
                    Toast.makeText(getApplicationContext(), "Şifre Ayarlandı.", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(SetPin.this, HomeActivity.class));
                    finish();
                }
                else {
                    Toast.makeText(getApplicationContext(), "Şifre Eşleşmiyor!", Toast.LENGTH_SHORT).show();
                }
